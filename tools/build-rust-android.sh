...
echo "Building libadblock_rust.so..."
...
cp target/aarch64-linux-android/release/libadblock_rust.so "$JNI_LIBS/arm64-v8a/"
cp target/armv7-linux-androideabi/release/libadblock_rust.so "$JNI_LIBS/armeabi-v7a/"
cp target/x86_64-linux-android/release/libadblock_rust.so "$JNI_LIBS/x86_64/"
